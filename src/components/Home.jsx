            ...
            <div className="flex flex-col items-center justify-center h-full">
              ...
              <div className="w-full flex justify-center items-center hero-button">
                <button
                  ...
                  className="absolute ml-2 lg:ml-4 md:ml-0 left-1/2 lg:left-1/4 md:left-1/2 -translate-x-1/2 bottom-0 md:bottom-8 lg:bottom-48 xl:bottom-56 z-50 px-8 py-3 rounded-xl font-semibold text-black shadow-[0_0_12px_rgba(255,255,255,0.8)] lg:landscape:bottom-34 hover:scale-110"
                  style={{
                    background:
